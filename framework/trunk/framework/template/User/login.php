<?php
	...
	if(!empty($_POST['login_submit']))
	{
		...
		if(Auth::check_login($_POST['user_email'], $_POST['user_password']) === FALSE)
		{
	...
	<div id="login_container">
		...
		<form action="" method="post">
			...
			<div class="field_row_wrapper">
				<h2>Email Address:</h2>
				<?= $this->load_helper('Validate')->print_text('user_email', '', array('title' => "Enter your account email address.", 'tabindex' => '1', "autocomplete" => "off")); ?>
			</div>
			...
			<div class="field_row_wrapper">
				...
				<?= $this->load_helper('Validate')->print_password('user_password', '', array("style" => 'width: 150px;', 'title' => "Enter your account password.", 'tabindex' => '2', 'autocomplete' => "off")); ?>
			</div>
