<?php
	...
	if(!empty($_POST['login_submit']))
	{
		...
		if($this->User->log_user_in($_POST))
		{
			...
			header("Location: {$this->config['web_path']}{$_SERVER['REQUEST_URI']}");
			exit;
		}else{
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= $this->config['web_path'] ?>/template/<?= $this->config['template_name'] ?>/css/log_in.css" />
...
<div class="width_container2">
	...
	<div id="login_container">
		...
		<form method="post">
			...
			<div class="field_row_wrapper">
				<h2>Password:</h2>
				<a class="password_reset" href="<?= $this->config['web_path'] ?>/user/reset_password/" title="Reset your account password.">Forgot your password?</a>
